...
import viking.mod.objects.blocks.item.ItemBlockVariants;
import viking.mod.util.handlers.EnumHandler;
import viking.mod.util.interfaces.IHasModel;
import viking.mod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension)
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.AM));
